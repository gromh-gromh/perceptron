...
build: ./src/perceptron/neuron/neuron.hpp ./src/perceptron/neuron/neuron.cpp ./src/perceptron/input/input.hpp ./src/perceptron/input/input.cpp ./src/perceptron/perceptron.hpp ./src/perceptron/perceptron.cpp ./src/main.cpp
	/usr/local/gcc-14.2.0/bin/gcc-14.2.0 -lstdc++ -std=c++20 -o ./build/main.out ./src/perceptron/neuron/neuron.hpp ./src/perceptron/neuron/neuron.cpp ./src/perceptron/input/input.hpp ./src/perceptron/input/input.cpp ./src/perceptron/perceptron.hpp ./src/perceptron/perceptron.cpp ./src/main.cpp -lm -g